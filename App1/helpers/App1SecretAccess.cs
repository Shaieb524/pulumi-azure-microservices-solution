...
{
    // App1 secret access with shared config support
    public class App1SecretAccess
    {
        private readonly Config _config;
        private readonly Config _sharedConfig;
        private readonly Dictionary<string, string> sharedConnectionStrings;

        public App1SecretAccess(Config config, Config? sharedConfig = null)
        {
        ...
        public Output<string> App1BlobAccountKey => _config.RequireSecret("App1BlobAccountKey");
        public Output<string> SendGridKey => _config.RequireSecret("SendGridKey");
        public Output<string> App1EventsTopicKey => _config.RequireSecret("App1EventsTopicKey");
        public Output<string> App1FnStorageKey => _config.RequireSecret("App1FnStorageKey");
        ...
        public Output<string> App1BlobKey => _config.RequireSecret("App1BlobKey");
        ...
        public Output<string> BuildApp1BlobConnectionString()
        {
            var databaseObj = _config.RequireObject<Dictionary<string, string>>("Database");
            var accountName = databaseObj.ContainsKey("App1BlobAccount") ? databaseObj["App1BlobAccount"] : throw new ArgumentException("App1 Blob Account not configured");
            return BuildBlobConnectionString(accountName, App1BlobKey);
        }
    }
}
